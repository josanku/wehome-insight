...
echo "══════════════════════════════════════════════════"
echo ""
echo "  1. wehome.me DNS에 위 CNAME 레코드 추가 (검증 + 라우팅)"
echo "  2. 5분~1시간 후 https://${DOMAIN} 접속 가능"
echo "  3. Kakao Developers → JavaScript SDK 도메인에 추가:"
echo "       https://${DOMAIN}"
echo "       https://${URL}"
echo "  4. Google Search Console에서 사이트맵 제출:"
